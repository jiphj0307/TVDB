...
export const SLOT_BANNER_SIZE = {
  ...
  food_right: '160x600',
  health_top: '728x90',
  health_bottom: '728x90',
  health_left: '160x600',
  health_right: '160x600',
}
...
export const DEFAULT_AD_SLOTS = [
  ...
  { id: 'health_top', name: '건강·생활·먹거리 상단', w: 728, h: 90, active: false, code: '', source: 'adsense' },
  { id: 'health_bottom', name: '건강·생활·먹거리 하단', w: 728, h: 90, active: false, code: '', source: 'adsense' },
  { id: 'health_left', name: '건강·생활·먹거리 좌측 사이드', w: 160, h: 600, active: false, code: '', source: 'adsense' },
  { id: 'health_right', name: '건강·생활·먹거리 우측 사이드', w: 160, h: 600, active: false, code: '', source: 'adsense' },
]
